const allQuestions = [
    ...
    {
        question: "四角形ABCDにおいてAB=CDかつAD//BCは、四角形ABCDが平行四辺形であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件であるが十分条件でない"
    },
    {
    ...
    {
        question: "a≧b であることは、|a-b|=a-b が成り立つための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "十分条件であるが必要条件でない"
    },
    {
        question: "x=4またはx=2は、x^2-2x-8=0を満たすための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要十分条件である"
    },
    {
        question: "nは整数とする。nは8の倍数であることは、nが偶数であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "十分条件であるが必要条件でない"
    },
    {
        question: "|a|<1であることは、a>-1であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "十分条件であるが必要条件でない"
    },
    {
        question: "-2<x<1は、-1<x<2を満たすための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件でも十分条件でもない"
    },
    {
        question: "|a|+|b|=0であることは、a=b=0であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要十分条件である"
    },
    {
        question: "c≠0とする。ac=bcは、a=bであるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要十分条件である"
    },
    {
    ...
    {
        question: "x=1であることは、x^2-3x+2=0であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "十分条件であるが必要条件でない"
    },
    {
        question: "ある三角形の2つの内角が等しいということは、その三角形が正三角形であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件であるが十分条件でない"
    },
    {
        question: "a>1またはb>-1は、a+b>0であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件でも十分条件でもない"
    },
    {
        question: "x<1またはy<1であることは、x+y<2であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件でも十分条件でもない"
    },
    {
        question: "x^2-2x-8=0は、x=4を満たすための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件であるが十分条件でない"
    },
    {
        question: "四角形ABCDが長方形であることは、四角形ABCDがひし形であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件でも十分条件でもない"
    },
    {
        question: "-2≦x≦3は、3x=6を満たすための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件であるが十分条件でない"
    },
    {
        question: "a≧bであることは、|a|-|b|=a-bであるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件でも十分条件でもない"
    },
    {
        question: "x^2-xy+y^2=0は、x=yであるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件であるが十分条件でない"
    },
    {
        question: "a=1，b=2であることは、ab+1=a+bであるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件であるが十分条件でない"
    },
    {
        question: "a>bであることは、a^2>b^2であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件でも十分条件でもない"
    },
    {
        question: "a，bは正の整数とする。a+bが3の倍数であることは、aとbがともに3の倍数であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件であるが十分条件でない"
    },
    {
        question: "xは自然数とする。xが素数であることは、xが奇数であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件でも十分条件でもない"
    },
    {
        question: "aは有理数であることは、aが実数であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "十分条件であるが必要条件でない"
    },
    {
        question: "-2≦x≦3は、x≧-3を満たすための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "十分条件であるが必要条件でない"
    },
    {
        question: "a>1またはb>1は、a+b>2であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "十分条件であるが必要条件でない"
    },
    {
        question: "a+b=ab+1は、a=1かつb=1であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件であるが十分条件でない"
    },
    {
        question: "三角形ABCにおいて、AB=ACかつAB=BCは、三角形ABCが正三角形であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要十分条件である"
    },
    {
        question: "-2<x<1は、-2≦x≦1であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "十分条件であるが必要条件でない"
    },
    {
        question: "ab=0であることは、a=b=0であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件であるが十分条件でない"
    },
    {
        question: "a=bは、a+c=b+cであるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要十分条件である"
    },
    {
        question: "x^2-3x+2>0であることは、x<1であるための",
        options: ["必要条件であるが十分条件でない", "十分条件であるが必要条件でない", "必要十分条件である", "必要条件でも十分条件でもない"],
        answer: "必要条件であるが十分条件でない"
    },
    {
